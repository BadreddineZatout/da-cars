<template>
  <div class="mx-5 my-20 text-xl sm:mx-40">
    <div>
      <h1 class="font-semibold">1. Inhalt des Onlineangebotes</h1>
      <p>
    ...
    <div class="mt-5">
      <h1 class="font-semibold">2. Verweise und Links</h1>
      <p>
    ...
    <div class="mt-5">
      <h1 class="font-semibold">3. Urheber- und Kennzeichenrecht</h1>
      <p>
    ...
    <div class="mt-5">
      <h1 class="font-semibold">4. Datenschutz</h1>
      <p>
